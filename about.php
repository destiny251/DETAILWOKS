							...
							<nav id="mainnav" class="mainnav">
								<ul class="menu">
                                    ...
                                    <li class="active">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="active"><a href="#" title="">About 01</a></li>
					...
					<div class="wrap-about">
						<div class="sidebar-about">
							...
							<div class="widget-brochures">
								<h3>Brochures</h3>
								<p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections</p>
								<ul class="download">
									<li class="pdf">
										<a href="#" title="">Download.PDF</a>
									</li>
									<li class="doc">
										<a href="#" title="">Download.DOC</a>
									</li>
								</ul>
							</div>
						</div>
