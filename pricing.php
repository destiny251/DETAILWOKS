...
<head>
	...
	<body>
								...
								<ul class="menu">
                                    ...
                                    <li class="active">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="#" title="">Pricing</a></li>
                                        </ul><!-- /.sub-menu -->
                                    </li>
                                    <li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="page-title-heading">
								<h1 class="h1-title">Pages</h1>
							</div><!-- /.page-title-heading -->
							<ul class="breadcrumbs">
								<li><a href="#" title="">Home<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
								<li><a href="#" title="">Pages<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
								<li>Pricing</li>
							</ul><!-- /.breadcrumbs -->
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="table-pricing">
							<table>
								...
								<tbody>
									<tr>
										<td class="title">Reference documents</td>
										<td>free</td>
										<td>free</td>
										<td>free</td>
										<td>free</td>
									...
									<tr>
										<td class="title">Support time</td>
										<td>10 minutes</td>
										<td>2 hours</td>
										<td>Unlimited</td>
										<td>Unlimited</td>
									...
									<tr>
										<td class="title">Finance Consulatant</td>
										<td>X</td>
										<td>1 month</td>
										<td>3 month</td>
										<td>Unlimited</td>
									...
									<tr>
										<td class="title">Choose Consultant</td>
										<td>X</td>
										<td>Yes</td>
										<td>Yes</td>
										<td>Yes</td>
									</tr>
									<tr class="price-number">
										<td></td>
										<td>0$</td>
										<td>80$</td>
										<td>120$</td>
		...
		<section class="flat-pricing style1">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="table-pricing style1">
							<table>
								<thead>
									<tr>
										<th></th>
								...
								<tbody>
									<tr>
										...
										<td>10 minutes</td>
										<td>x</td>
										<td><a href="#" title="">0$</a></td>
									</tr>
									<tr>
										<td class="title"><span>POPULAR</span>GOLD</td>
										<td>free</td>
										<td>1 month</td>
										<td>2 hours</td>
										<td>1 month</td>
										<td><a href="#" title="">80$</a></td>
									</tr>
									<tr class="platinum">
										<td class="title">PLATINUM</td>
										<td>free</td>
										<td>3 months</td>
										<td>Unlimited</td>
										<td>3months</td>
										<td><a href="#" title="">120$</a></td>
									</tr>
									<tr>
