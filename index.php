...
<head>
    ...
    <link href="images/detailwoks LOGO 2.jpg">
    <link href="images/detailwoks LOGO 2.jpg">
    <link href="images/detailwoks LOGO 2.jpg">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div id="logo" class="logo">
                            <a href="#" title="">
                                <img ="images/test.jpg" alt="DETAILWOKS" />
                            </a>
                        </div><!-- /#logo -->
                    </div>
                    <div class="col-lg-3 col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-ft widget-about">
                            <div id="logo-ft">
                                <a href="#" title="">
                                    <img src="images/detailwoks LOGO 3.jpg">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-ft widget-lastest">
                            ...
                            <ul>
                                <li>
                                    <a href="#" title=""><i class="fa fa-twitter"></i>@DETAILWOKS</a> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.
                                </li>
                                <li>
                                    <a href="#" title=""><i class="fa fa-twitter"></i>@DETAILWOKS</a> Lorem Ipsum is simply dummy text of the printing and typesetting.Lorem Ipsum is simply dummy.
                                </li>
                            </ul>
                        </div><!-- /.widget-services -->
                    </div><!-- /.col-md-3 col-sm-6 -->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            <p>© Copyright <a href="#" title="">DETAILWOKS 2020</a>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
