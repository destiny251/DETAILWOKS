								...
								<ul class="menu">
                                    ...
                                    <li class="active">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="#" title="">About 03</a></li>
                                        </ul><!-- /.sub-menu -->
                                    </li>
                                    <li>
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="about-us style1">
							...
							<div class="content">
								<div class="motto">
									“Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer tookt"
								</div>
						...
						<div class="call-back-form">
							...
							<form action="#" method="get" accept-charset="utf-8">
								...
								<p class="form-freeback">
									<textarea name="freeback" placeholder="How can we help?"></textarea>
								</p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="imagebox style2 v1">
							<div class="imagebox-image">
								<img src="images/imagebox/13.jpg" alt="">
							</div>
							<div class="imagebox-content">
